...
run_full() {
  ...
  expect_allow shell "git -c credential.helper=store credential fill" "safe Git credential helper"
  expect_allow shell "git -c credential.helper='rm -rf .' credential fill" "ordinary Git credential helper receives a Git prefix"
  expect_allow shell "git -c credential.helper='!printf ok' credential fill" "safe Git credential shell snippet"
  ...
  expect_allow git "git stash pop" "stash pop"
