...
After installing canonical skills for the current agent, check OTHER agent skill directories (`.agents/skills/`, `.gemini/skills/`, `.claude/skills/`, `.github/skills/`) for stale goat-flow skill names:
