...
## Autonomy Tiers
**Always:** Read any permitted, non-secret file needed for setup. Set up Copilot-owned surfaces: `.github/copilot-instructions.md`, `.github/skills/`, `.github/hooks/`, and shared `.goat-flow/`.

**Ask First:** before modifying a boundary outside Copilot ownership, ask and wait for approval; include boundary touched, related code read, footgun checked, local instruction checked, and rollback command.
