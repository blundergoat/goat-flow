# Prompt: Create /goat-reflect Skill

Paste this into your coding agent to create an instruction tuning skill that proposes edits to instruction files based on session friction.
...
```
Create the /goat-reflect skill with the following SKILL.md content:
