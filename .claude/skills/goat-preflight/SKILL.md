...
3. **Cross-reference integrity:** Grep for any file paths referenced in CLAUDE.md router table and verify they exist

### SHOULD pass (non-blocking)
4. **Markdown link check:** Verify internal links in changed .md files resolve to real files
5. **Line count audit:** `wc -l CLAUDE.md` — warn if over 100
...
- [PASS/FAIL] CLAUDE.md line count: [N] lines (target: 100)
