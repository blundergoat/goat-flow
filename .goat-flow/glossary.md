...
|------|-----------|----------------|---------|
| Anti-Pattern Deduction | Removed in v1.1.0. Was a scored penalty system (AP1-AP23) applied by the scanner/rubric engine. Replaced by advisory quality checks in `src/cli/audit/harness-checks.ts`. | — | — |
...
| Triangular Tension | A mob elaboration technique that stress-tests a plan from three competing perspectives to surface hidden risks. | `.goat-flow/templates/mob-elaboration.md` | -- |
