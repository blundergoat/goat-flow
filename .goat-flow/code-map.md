...
├── diagnostics-command-parser.ts = lightweight `diagnostics context` positional rules
├── diagnostics-command.ts      = lazy context-report fact extraction and format dispatch
