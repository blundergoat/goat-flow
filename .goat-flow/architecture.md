...
Coordination claims are not generic cleanup candidates. `.goat-flow/state/locks/*.claim` remains fail-closed until owner-checked release or explicit recovery after an operator confirms no active writer; elapsed time never authorizes removal.
