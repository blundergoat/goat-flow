...
- **Version-mismatched surfaces.** `package.json` says 1.7.1, `CHANGELOG.md` tops out at 1.6.4, README says 1.8.0. Every release should bump every version surface; preflight should enforce.
