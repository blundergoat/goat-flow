...
- Trajectory replay (per `.goat-flow/tasks/related-improvement-ideas/M03-deterministic-skill-replay.md`) replays recorded provider messages; the replay harness needs to handle the same shape variants mini does.
