...
- `src/dashboard/dashboard-terminal.ts` (search: `TERMINAL_PASTE_COMMIT_DELAY_MS`) now delays Claude and Antigravity Enter submits after pasted-text markers so the TUI has a quiet window to commit the collapsed paste before Enter is sent.
