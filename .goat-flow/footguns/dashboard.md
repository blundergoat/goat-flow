...
3. For browser-side sends, keep bracketed paste and Enter as separate ordered WebSocket inputs; do not collapse them back into one `paste + "\r"` payload.
