...
**Prevention:** Generate Codex hook commands through the root-resolving Node bootstrap, including the Windows override. Replay the exact command and require a fresh trusted provider capture before extending delivery claims to an event or mode.
