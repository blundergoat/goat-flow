...
**Decision changed:** Resolve an artifact reference through the authoritative mirror table rather than a directory naming convention, and distinguish executable grammar from product prose before flagging a removed command.
**Trigger phase:** ACT
**Caught at:** VERIFY
**Incident count:** 1 | **Latest occurrence:** 2026-07-12
**Merged:** 2026-09-05 - six plan-parsing, human-gate, lifecycle-baseline, and negative-proof recurrences moved to the entries that own them in `.goat-flow/learning-loop/lessons/milestone-accounting.md` and `.goat-flow/learning-loop/lessons/verification.md`; none of them were artifact-scanner incidents.
