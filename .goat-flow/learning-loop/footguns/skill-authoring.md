...
**Update 2026-08-19:** combined cap raised 4700 -> 5450 with user approval for the ISSUE.md plain-language redesign (checkable rules, a word swap table, two worked pairs, and a labelled worked sample moved inline into `issue-format.md`; 5373 used). The sweep for the old number found no live citations; old-format ISSUE and milestone artifacts under `.goat-flow/plans/` were left as historical outputs. Body cap unchanged (2128/2150 used).
