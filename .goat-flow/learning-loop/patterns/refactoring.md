...
- 2026-08-13: `test/integration/setup-install-migrations.test.ts` (search: `setup --apply installer upgrade migrations`) reached 751 lines after formatting with a green suite; removing one blank line fixed it.
