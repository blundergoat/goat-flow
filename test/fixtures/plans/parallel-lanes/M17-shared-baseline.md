...
Actual: retrospective: ~3 min agent-time (1 product / 1 proof / 1 other) - synthetic fixture; no measured work claimed
...
- [x] Supply the bounded scheduling input. (est: 1 min product)

## Proof

- [x] The scheduling snapshot matches the expected CLI result. [automated] (est: 1 min proof)
