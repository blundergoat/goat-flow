...
- **New plans use a narrower forecast range** - Until three measured milestones exist, `/goat-plan` and `plans check` use `0.5-2.5-6 min/unit` instead of `0.5-2.5-10`; saved forecasts remain valid. Across 133 measured milestones in this repository, coverage was 85% versus 94%.
...
- **Codex hook evidence distinguishes platform and scenario proof** - Windows launchers preserve the working directory; upgrade from 1.16.0 with `goat-flow hooks sync .` and restart Codex. PostToolUse delivery was captured on CLI 0.149.1 on 2026-08-27; Linux interactive CLI 0.154.0 delivered conflict feedback and completed after repair, expiring 2026-10-17. Fixed-scenario verification remains required.
