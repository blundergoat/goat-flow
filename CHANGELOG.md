...
Plan completion protocol, hook version enforcement, deny-hook hardening, dashboard prompt/quality upgrades, instruction artifact routing, harness-score honesty, and README rewrite. 105 files changed.
