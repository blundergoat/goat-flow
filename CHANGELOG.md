...
- **PR #56 correctness follow-ups** - Covers `|&`, secret redaction, scoped drift, export collisions, audit recovery, summaries, gitignore parity, and mirrored safety contracts.
