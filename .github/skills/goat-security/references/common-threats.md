...
Report each as claim @ authority | evidence status | proof-class. Only `OBSERVED` may support clearance; `INFERRED`/`UNVERIFIED`/`HUMAN-PENDING` MUST NOT.
