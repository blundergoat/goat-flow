...
.claude/skills/research/SKILL.md       ← optional for single-domain libraries
.claude/skills/code-review/SKILL.md    ← optional for single-domain libraries
...
- **The article** (`ai-workflow-ARTICLE-prime.md`) — narrative version with real implementation data from four projects
...
- **Codex adaptation** (`codex-workflow-implement-prompt.md`) — implementation prompt for adapting the workflow system to OpenAI Codex. Produces AGENTS.md, playbook files, and validation scripts instead of hooks.
